...
//	boost::shared_ptr<TEfficiency> hadronTriggerLegEfficiencyHistogram_nonIsoJets ((TEfficiency*) file->Get("data_1")->Clone());
//	boost::shared_ptr<TEfficiency> hadronTriggerLegEfficiencyHistogram_isoJets ((TEfficiency*) file->Get("data_2")->Clone());
//	boost::shared_ptr<TEfficiency> hadronTriggerLegEfficiencyHistogram_isoPFJets ((TEfficiency*) file->Get("data_3")->Clone());
